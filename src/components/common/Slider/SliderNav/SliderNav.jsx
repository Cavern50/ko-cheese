...
export const SliderNav = (props) => {
  const { title, prev, next, allCount, currentCount, params: { counter, counterBottom, seeAll, isGallery } } = props;
  const counterProps = { isGallery, counter, counterBottom, currentCount, allCount, prev, next };
  return (
    <>
